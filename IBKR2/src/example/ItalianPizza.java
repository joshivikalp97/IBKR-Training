...
public class ItalianPizza extends pizza {
		...
		public ItalianPizza(String type, String topping, String name,String size, int quantity, String variant) {
	...
	public String toString() {
		...
		return "Italian Pizza: "+type +" "+ name +" pizza with "+ topping +" and size of pizza is "+size+" and its price is "+costOfPizza ;
